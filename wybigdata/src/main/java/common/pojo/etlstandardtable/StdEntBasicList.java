 ...
 * @author: dxx
 * @version: V-Cloude
 * @date: 2018/12/17 19:38
 * @copyright©: 2018东方微银科技（北京）有限公司
 * @file_name: wybigdata
 * @pachage_name: common.pojo.etlstandardtable
 * @description:
 */
public class StdEntBasicList implements Serializable {
    private String uuID;
    ...
    public Double getReccap() {
        return reccap;
    }

    public void setReccap(Double reccap) {
        this.reccap = reccap;
    }
    ...
    public String getIdentitycardnt() {
        return identitycardnt;
    }

    public void setIdentitycardnt(String identitycardnt) {
        this.identitycardnt = identitycardnt == null ? null : identitycardnt.trim();
    }
