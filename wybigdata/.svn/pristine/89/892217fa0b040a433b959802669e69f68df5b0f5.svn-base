package com.dfwy.online.sparkstreamingtask.vcloude.task.hbase;
...
public class HBaseOperater {
    public static void data2HBase(String record, ApplicantInformationTO applicantInformationTO, String jsonStr) throws Exception {
        ...
        try {
            ...
            //中诚信原始报文数据
            String ccxData = applicantInformationTO.getElementscreditData();
            //元素原始报文数据
            String elementscreditData = applicantInformationTO.getCcxData();
            //ReqId
            ...
            if (StringUtils.isNotEmpty(amarsoftData)) {
                ...
                columnFamily_column_1 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_1;
                columnFamily_column_2 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_1;
                columnFamily_column_3 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_1;
            }
            if (StringUtils.isNotEmpty(ccxData)) {
                dataSourceKey = Dfwybank_VCloude_Hbase_BusinessJustice_DateSourceKey_2;
                columnFamily_column_1 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_2;
                columnFamily_column_2 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_2;
                columnFamily_column_3 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_2;
            }
            if (StringUtils.isNotEmpty(elementscreditData)) {
                dataSourceKey = Dfwybank_VCloude_Hbase_BusinessJustice_DateSourceKey_3;
                columnFamily_column_1 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_3;
                columnFamily_column_2 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_3;
                columnFamily_column_3 = Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_ColumnName_3;
            }
            //向“data”列簇存入数据报文（整体）
            ...
            if (StringUtils.isNotEmpty(dataSourceKeyFromJsonString)) {
                put.addColumn(Bytes.toBytes(Dfwybank_VCloude_Hbase_BusinessJustice_ColumnFamily_2),
                        Bytes.toBytes(columnFamily_column_2), Bytes.toBytes(dataSourceKeyFromJsonString));
            }
