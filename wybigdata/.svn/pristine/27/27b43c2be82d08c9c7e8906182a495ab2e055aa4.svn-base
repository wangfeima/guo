...
public class DateUtils {
    //SimpleDateFormat数据非线性安全，所以在多线程状态下需要每个线程一个SimpleDateFormat。此工具类，未修改完成！
     ...
     * @return
     */
    public static int dayDiff(String altDate) {
        return 365;
    }
    public static int getDateDiff_Minus_Positive(String caseTime, String pendecissDate) {
        return 365;
    }
     ...
     * SimpleDateFormat formatter = new SimpleDateFormat(pattern);此对象时线程不安全的，
     * 所以，在多线程使用时，要加同步锁或者每个线程私有化一个实例或者找到其他方案！
     * @param strDate
     * @return
     */
